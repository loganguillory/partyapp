...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { EventID: @attendee.EventID, UserID: @attendee.UserID } }, as: :json
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { EventID: @attendee.EventID, UserID: @attendee.UserID } }, as: :json
    assert_response :success
  end
